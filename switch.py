...
SWITCH_DESCRIPTIONS: tuple[GGSSwitchDescription, ...] = (
    ...
    GGSSwitchDescription(
        ...
        turn_on_fn=lambda c: c.async_set_module_manual("fan", True),
        turn_off_fn=lambda c: c.async_set_module_manual("fan", False),
    ),
    GGSSwitchDescription(
        key="light",
        name="Grow Light",
        ...
        turn_on_fn=lambda c: c.async_set_module_manual("light", True),
        turn_off_fn=lambda c: c.async_set_module_manual("light", False),
    ),
    GGSSwitchDescription(
        key="blower",
        name="Blower",
        ...
        turn_on_fn=lambda c: c.async_set_module_manual("blower", True),
        turn_off_fn=lambda c: c.async_set_module_manual("blower", False),
    ),
    ...
    GGSSwitchDescription(
        ...
        turn_on_fn=lambda c: c.async_set_module_manual("humidifier", True),
        turn_off_fn=lambda c: c.async_set_module_manual("humidifier", False),
    ),
    GGSSwitchDescription(
        key="light2",
        name="Grow Light 2",
        ...
        turn_on_fn=lambda c: c.async_set_module_manual("light2", True),
        turn_off_fn=lambda c: c.async_set_module_manual("light2", False),
    ),
    GGSSwitchDescription(
        key="heater",
        name="Heater",
